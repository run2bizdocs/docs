...
Description: Notas de release, correcciones de errores y mejoras en la 4biz.
...
|Ticket 3505|Corrección|Builder|Corrección de los componentes Builder|
...
Bienvenido a 4biz Versión 8.0.5.0. Esta versión tiene las siguientes mejoras:
...
|4309|[Ticket ] - Ticket con informe Builder excede el tamaño de pantalla predeterminado al ver las variables de flujo.|
...
Bienvenido a 4biz Versión 8.0.1.5. Esta versión tiene las siguientes correcciones:
...
Bienvenido a 4biz Versión 8.0.1.4. Esta versión tiene las siguientes correcciones:
...
|4599|Instalación - Errores de script al cargar 4biz en base cero.|
...
|4825|Builder - No se pueden cambiar los parámetros en la base Oracle.|
...
|4729 |[MY-804] - Error al acceder a la aplicación Simple en la aplicación Mobile 4biz Experience.|
...
|--------|-----------|
|4730|Error al crear un ticket a través del Smart Portal cuando no tiene Builder o Cuestionario|
...
|4650|[My 686] - Cuando realiza aprobaciones de tickets de token por correo electrónico, se le dirige a una página de 4biz en el navegador EDGE/MOZILA/CHROME donde la información aparece en inglés incluso con la parametrización en portugués.|
...
| 3698       | [ITSM 9816] - Algunas URL de 4biz no están respetando la configuración de jboss-web.xml. Es decir, cuando el contexto se cambia de "citsmart" a "anac", o algo así. Las pantallas como formulario Builder y mantenimiento de flujo dejan de funcionar. \#3790 | Correctiva |
...
| 2870       | [Builder] Optimización de la carga de internacionalización                                                                                                                                                                                                              | Correctiva |
...
[15]:/es-es/4biz-helium/additional-features/project-management/simple-agile-management/simple-agile-management.html
...
[20]:/es-es/4biz-helium/additional-features/mobile-and-field-service/apps/citsmart-field-service-manual.html
[21]:/es-es/4biz-helium/additional-features/mobile-and-field-service/apps/citsmart-app.html
