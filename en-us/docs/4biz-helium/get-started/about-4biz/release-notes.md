...
Welcome to 4biz Version 8.0.2.0. This release has the following fixes and improvements:
...
|4309|[Ticket] - Ticket with Builder form exceeds the default screen size when viewing flow Variables.|
...
Welcome to 4biz Version 8.0.1.5. This release has the following fixes:
...
Welcome to 4biz Version 8.0.1.4. This release has the following fixes:
...
|4599|Installation - Script errors when uploading 4biz on zero basis.|
...
|4825|Builder - Unable to change parameters in Oracle database.|
...
|Problem|Description|
|-------|-----------|
|4730|Error creating a ticket through Smart Portal when it has no Builder or Questionnaire|
...
|4650|[My 686] - When you make approvals of tickets via token by e-mail, you are directed to a 4biz page in the EDGE/MOZILA/CHROME browser, where the information is appearing in English even with the parametrization in Portuguese.|
...
| 2870       | [Builder] Internationalization load optimization                                                                                                                                                                                                              | Corrective   |
...
| 3424       | Validate Builder parameters before saving                                                                                                                                                                                                                   | Corrective   |
...
| 2777     | Intermittent failure in the method that returns timezone to register the date and hour. In the Builder component. Version 8.0.0.3 provides definitive solution in the Builder component to register date and time. |
