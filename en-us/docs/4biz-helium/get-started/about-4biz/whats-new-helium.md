Title: What's new in 4biz Helium?
...
Approving a ticket by 4biz is simpler, just click on the approve icon **(a.)**, you can view the ticket details and approve it or not **(b.)**.
...
To facilitate the organization and classification of change registrations, 4biz started to use the concept of Change Portfolio, allowing pre-set templates with attendance flow, calendar, responsible groups and others **(a.)**, and the classification of change has become much simpler and more agile **(b.)**.
...
For further information access the documentation about [Mobile 4biz Experience][8]
