...
![Centros de Experiência](images/experience-center.png)
...
![Criação de CE](images/experience-center-creation.png)

![Visualização de um CE](images/experience-center-visualization.png)
...
![Portfólios do usuário logado](images/logged-user-portfolio.png)
...
![a-Tickets do usuário logado](images/logged-user-ticket.png)

![b-Linha do Tempo do Ticket](images/ticket-timeline.png)

![c-Notas para o Atendente](images/attendant-note.png)

![d-Chat com o Atendente](images/chat-with-attendant.png)

Saiba mais sobre o [Centro de Experiência][1]

### Widget Minhas Aprovações

Aprovar um ticket pelo 4biz ficou mais simples, basta clicar no ícone aprovar **(a.)**, é possível visualizar os detalhes do ticket e aprovar ou não **(b.)**.
...
![](images/smart-decisions-panel.png)

Acesso Rápido
-------------

Novos ícones e área de acesso rápido aos processos e portais foram disponibilizados no área superior da plataforma de forma a tornar mais simples e prático o acesso às funcionalidades do 4biz. 
...
![a-Atendimento do ticket](images/ticket-attendance.png)

![b-Seleção de portfólio](images/portfolio-selection.png)

![c-Fluxo do atendimento](images/attendance-flow.png)

![d-Mensagem ao Solicitante](images/message-to-requester.png)
...
![a-Notas e comentários](images/notes-comments.png)

![b-Histórico de Ticket](images/ticket-history.png)
...
![a-Notificação de solução de contorno](images/workaround-notification.png)

![b-Solução de contorno](images/workaround.png)
...
![Detalhamento do Problema](images/problem-detail.png)
...
![a-Incidentes de um problema](images/problem-incident.png)

![b-Registro de problema](images/problem-registration.png)

![c-Templates de problema](images/problem-template.png)
...
![a-Lista de IC´s](images/ci-list.png)

![b-Detalhamento do IC](images/ci-detail.png)
...
![a-Diagnóstico do problema](images/problem-diagnosis.png)
...
![b-Revisão e fechamento](images/review-closure.png)
...
![c-Tipos de IC](images/types-ci.png)

![d-Detalhamento por tipo de IC](images/detail-by-type-ci.png)
...
![a-Detalhamento do IC](images/ci-detail-2.png)

![b-Garantias do IC](images/ci-warranty.png)
...
O 4biz evoluiu o Gerenciamento de Mudanças para dar mais agilidade, segurança e praticidade as mudanças em ambientes que vão além da TI . Com um novo painel de listagem é possível alterar colunas de exibição, ativar atualização automática, visualizar andamento do fluxo, pesquisar registro, acessar lista de relatórios dinâmicos etc.

![Gerenciamento de mudanças](images/change-management.png)
...
![Detalhamento da mudança](images/change-detail.png)

Para facilitar a organização e a classificação dos registros de mudança, o 4biz passou a utilizar o conceito de Portfólio de Mudanças, permitindo pré-configurar templates com fluxo de atendimento, calendário, grupos responsáveis etc **(a.)**, e a classificação da mudança se tornou muito mais simples e ágil **(b.)**.

![a-POrtfólio de mudança](images/portfolio-of-change.png)

![b-Classificação da mudança](images/classification-of-change.png)
...
![a-Gráfico de análise de risco](images/risk-analysis-chart.png)

![b-Planejamento da mudança](images/change-planning.png)
...
![Revisão e fechamento](images/review-closure-2.png)
...
![Gerenciamento de Liberação](images/release-management.png)
...
![a-Menu lateral](images/side-menu.png)

![b-Lista de liberações](images/release-list.png)
...
![Auditoria de dados](images/data-audit.png)

**Auditoria de Acesso**

Nesta opção é apresentado o histórico dos acessos ao sistema (entradas e saídas)

![Auditoria de Acesso](images/access-audit.png)
...
O App 4biz GO foi criado para dar mais flexibilidade e agilidade em atendimentos realizados em campo. As funcionalidades do app podem ser executadas offline e depois sincronizadas de forma fácil.
...
![App FS](images/65-app-fs.png)

![App FS](images/66-app-fs.png)

![App FS](images/68-app-fs.png)

![App FS](images/69-app-fs.png)

Saiba mais sobre [4biz GO][7]

## App 4biz Experience

O App 4biz Experience foi criado para que as facilidades e benefícios da solução 4biz possam ser acessados também via dispositivos móveis, esta nova versão inclui notificações para o sistema operacional Android e a possibilidade de confirmação de atendimento via assinatura.

Saiba mais sobre [Mobile 4biz Experience][8]

![App Mobile SM](images/71-app-mobile-sm.png)

![App Mobile SM](images/72-app-mobile-sm.png)

![App Mobile SM](images/73-app-mobile-sm.png)

![App Mobile SM](images/74-app-mobile-sm.png)

![App Mobile SM](images/75-app-mobile-sm.png)



[1]:/pt-br/4biz-helium/processes/knowledge/use/create-experience-center.html
[2]:/pt-br/4biz-helium/additional-features/project-management/simple-agile-management/simple-agile-management.html
[3]:/pt-br/4biz-helium/processes/problem/overview.html
